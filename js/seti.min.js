...
"sel",PARA_ORDER="ord_col",PARA_ORDER_DIR="ord_dir",COLUMN_TEAM=0,COLUMN_ALL_TEAM=1,COLUMN_COUNTRY=2,COLUMN_USER=3,TEAM_SNL="30190",g_siteUrl,g_hide_table=!1,g_selected=[],g_table,g_order=-1,g_order_dir="",g_initSorting=!0,g_table_interval_timer=null,g_current_table=null,g_team_id,g_team_name,g_team_same=!1,g_table_type=TABLE_TEAMS_ALL,g_page_length=10,g_page_nr=null,g_page_nr_type=TABLE_TEAMS_ALL,g_location_base="";$(document).ready(function(){UrlChange();window.onpopstate=function(b){UrlChange()}});
